...
import { CocomoIIProvider, useCocomoII } from './context'
import StepNavigation from './components/StepNavigation'
import Step1BasicParameters from './components/Step1BasicParameters'
import Step2ScaleFactors from './components/Step2ScaleFactors'
...
function CocomoIIWizard() {
  const { state } = useCocomoII()
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex flex-row justify-between">
          ...
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Estimador COCOMO II</h1>
              <p className="text-gray-600">Modelo de estimación de costos de software avanzado</p>
            </div>
          </div>
          <Link
            href="/cocomo-ii/docs"
